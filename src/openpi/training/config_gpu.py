...
class TrainConfig:
    ...
    # How often (in steps) to evaluate total loss on fixed, non-shuffled batches. Disabled when <= 0.
    eval_interval: int = 0
    # Number of fixed batches used for eval loss. Disabled when <= 0.
    eval_batches: int = 0
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        weight_loader=weight_loaders.ACOTCheckpointWeightLoader(
            os.getenv("ACOT_PI05_PARAMS_PATH", "/mnt/public/zhonglinqing/pkgs/pi05_model/params")
        ),
